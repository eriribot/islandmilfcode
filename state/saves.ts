...
export function normalizePlayerProfile(input: unknown): PlayerProfile {
  ...
  return applyProfileDefaults({
    ...
    schoolCalendarBaseClassName: raw.schoolCalendarBaseClassName ? String(raw.schoolCalendarBaseClassName) : undefined,
    schoolIdentityKind: raw.schoolIdentityKind ? String(raw.schoolIdentityKind) : undefined,
    schoolIdentityLabel: raw.schoolIdentityLabel ? String(raw.schoolIdentityLabel) : undefined,
    schoolCalendarSyncedAt: raw.schoolCalendarSyncedAt ? String(raw.schoolCalendarSyncedAt) : undefined,
