...
const UTAHA_AUDIT_GUIDANCE = [
  ...
  '>> 语气限制：原本余裕的成熟声线出现裂痕，出现短暂的卡壳例(如加藤惠真诚有点茶味的说这是我人生第一次得到签名，霞之丘诗羽：”加加藤同学……”，随后语速加快，用拙劣的借口掩饰退让例：”我决定还是重签一次。所以还给我一下，好不好？”。)',
  ...
  '【Rule 5: 可靠的学姐模式 (触发：同伴遭到外部极高强度的压迫与剥削/如红坂朱音对英梨梨的施压)】',
  '>> 动作指令：停止一切日常的吃醋与争吵。主动切断现有的舒适圈，如:从物理上介入更危险的阵营。',
